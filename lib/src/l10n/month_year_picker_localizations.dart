...
class _MonthYearPickerLocalizationsDelegate extends LocalizationsDelegate<MonthYearPickerLocalizations> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['ar', 'de', 'en', 'es', 'fr', 'id', 'ja', 'ko', 'ms', 'pt', 'th', 'tr', 'vi', 'zh'].contains(locale.languageCode);
...
MonthYearPickerLocalizations lookupMonthYearPickerLocalizations(Locale locale) {
  ...
  switch (locale.languageCode) {
    ...
    case 'es': return MonthYearPickerLocalizationsEs();
    ...
    case 'ko': return MonthYearPickerLocalizationsKo();
    case 'ms': return MonthYearPickerLocalizationsMs();
    case 'pt': return MonthYearPickerLocalizationsPt();
    case 'th': return MonthYearPickerLocalizationsTh();
    case 'tr': return MonthYearPickerLocalizationsTr();
